...
public class VentanaRenunciarAsig extends javax.swing.JFrame {
    ...
    public VentanaRenunciarAsig() {
        initComponents();
        try {
            Controlador.listadoAlumnosComboBox(cbAlumno);
    ...
    private void bRenunciarActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_bRenunciarActionPerformed
        // TODO add your handling code here:
        Alumno alum =  Controlador.getAlumno(cbAlumno.getSelectedIndex());
        boolean borrado = Controlador.deleteAsigFromAlumno(alum.getDNI(),cbAsignatura.getSelectedIndex());
        if (borrado){
